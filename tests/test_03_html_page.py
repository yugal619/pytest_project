...
class TestHtmlPage:
    ...
    def test_01_html_page_title(self):
        """Verifies Title of Html page"""
        # driver = browser_setup
        logger.info(f"Browser: {self.driver.browser_name}")
        html_page = HtmlPage(self.driver)
        self.driver.get('https://testpages.eviltester.com/styled/basic-html-form-test.html')
    ...
    def test_02_html_page(self, setup_driver, form_data: list):
